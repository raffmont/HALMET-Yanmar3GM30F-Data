...
- [ ] Confirm the OLED shows the boot page, live status, and the current Wi-Fi or provisioning AP IP address.
...
- [ ] Confirm PGNs `127488`, `127489`, `127493`, and `127505` on a test NMEA 2000 bus.

## On vessel, engine stopped

- [ ] Verify D1-D4 voltage levels in key-off, key-on, alarm-test, and SD20 sail drive seal switch states.
